...
const EventForm = ({
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const event = {
      id: String( editingEvent ? editingEvent.id : new Date().getTime()),
      title,
      date,
      reminder,
    };
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="flex justify-between items-center">
        <button
          type="submit"
          className="bg-[#273463] hover:bg-[#212e58] text-white px-4 py-2 rounded"
        >
        ...
        {editingEvent && (
          <button
            type="button"
            className="bg-red-600 rounded-md shadow-sm hover:bg-red-800 text-white px-4 py-2 "
